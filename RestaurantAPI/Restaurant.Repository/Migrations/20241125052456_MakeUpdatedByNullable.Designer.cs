...
namespace Restaurant.Repository.Migrations
{
    ...
    [Migration("20241125052456_MakeUpdatedByNullable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurant.Domain.Identity.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Restaurant.Domain.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("TotalPriceCents")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Restaurant.Domain.Identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Restaurant.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("Restaurant.Domain.Identity.User", "UpdatedBy")
                        .WithMany()
